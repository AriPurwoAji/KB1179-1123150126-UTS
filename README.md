...
### screenshoot
![Splash Screen](assets/images/splash_screen_1.png)
![Splash Screen](assets/images/splash_screen_2.png)
![Splash Screen](assets/images/splash_screen_3.png)
![Splash Screen](assets/images/sign_in.png)
...
2. Clone repository ini:
   ```bash
   git clone https://github.com/AriPurwoAji/KB1179-1123150126-UTS.git